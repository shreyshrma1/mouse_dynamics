...
Same as shen_svdd_scroll.py but adds UMAP dimensionality reduction
between standardization and ClassicSVDD.

Pipeline per user:
  raw features → StandardScaler → UMAP → ClassicSVDD

Usage:
    python measurements/svdd_umap.py
    python measurements/svdd_umap.py --n_components 10 --n_neighbors 15
"""
...
def main():
    ...
    print(f"Pipeline: StandardScaler → UMAP → ClassicSVDD\n")
    ...
    for user in BALABIT_USERS:
        ...
        # Accepted when score <= 0 (inside sphere)
